	...
	<div class="flex flex-col justify-center">
		<div class="flex flex-col items-center justify-center">
			<label class="input input-sm w-[200px]">
				<span class="label w-[100px]">Acceleration</span>
				<input bind:value={acceleration} placeholder="" class="w-[50px]" />
			</label>
		...
		<button
			...
			onclick={() => {
				M3.MoveWithAcceleration($SelectedAxis, acceleration, duration);
			}}
		>
